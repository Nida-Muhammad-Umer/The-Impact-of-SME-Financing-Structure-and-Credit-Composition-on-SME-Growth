...
Increasing access to financing alone is not enough —
structured and targeted credit allocation drives SME growth.

Business Impact

This project provides actionable insights for:

Financial institutions optimizing SME lending
Policymakers designing credit programs
Improving financial inclusion strategies
Visual Output
...
Key Contributions
End-to-end time series analysis on real-world data
Transition from regression → time series modeling
Integration of macroeconomic insights with statistical modeling
Business-oriented interpretation of results
Future Improvements
Incorporate firm-level SME data
Include informal financing channels
Enhance model with additional macroeconomic variables
Author
